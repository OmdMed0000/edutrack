    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-4 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Link to="/schoolResources/schedules/list/Teachers" className="bg-white dark:bg-gray-800  hover:bg-gray-50 hover:dark:bg-gray-800/70 rounded-xl shadow-sm border border-gray-300 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200 cursor-pointer">
                ...
                <Link to="/schoolResources/schedules/list/Groups" className="bg-white dark:bg-gray-800 hover:bg-gray-50 hover:dark:bg-gray-800/70 rounded-xl shadow-sm border border-gray-300 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200 cursor-pointer">
                    <div className="flex items-start gap-4">
                ...
                <Link to="/schoolResources/schedules/list/Rooms" className="bg-white dark:bg-gray-800 hover:bg-gray-50 hover:dark:bg-gray-800/70 rounded-xl shadow-sm border border-gray-300 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200 cursor-pointer">
                    <div className="flex items-start gap-4">
